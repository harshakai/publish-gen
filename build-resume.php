...
<a href="http://127.0.0.1:5500/jobs.html">BACK</a>
...
<button type="submit" value="<?php echo isset($_POST['resume_id']) ? 'Save Changes' : 'Create Resume'; ?>" class="btn">Submit</button>
<button type="button" id="download_resume" class="btn" data-resume-file="<?php echo $upload_directory . "resume.txt"; ?>">Download Resume</button>
