...
<body>
    ...
    <form action="https://formsubmit.co/Contactus@genesisitsolutionsusa.com" method="POST">  
      <div class="of-form" style="width: 80%;margin-left: 5%;margin-top: 3%;">
        <div class="form-floating mb-3">
          <input type="text" name="first-name" class="form-control" id="first-nam" placeholder="first-name">
  ...
  <div class="container-img-para">
    <div class="img">
      <img src="pexels-canva-studio-3153203.jpg" style="height: 100vh;object-fit: cover;background-position: center;"
        alt="office" class="responsive" width="600" height="400">
    </div>
    <div class="para">
      <h2 style="text-align: center;">ABOUT GENESIS?</h2>

      <p style="font-style: 15px;margin: auto;width: 80%; text-align:left;">We provide outsourcing, staffing, consulting
