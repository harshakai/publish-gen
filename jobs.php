...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  if (isset($_POST['apply_job']) && isset($_POST['job_id']) && isset($_FILES['resume'])) {
    ...
    try {
      ...
      // Server settings
      $mail->isSMTP();
      $mail->Host       = 'smtp.kanimerakalaharshavardhan@gmail.com'; // Replace with your SMTP server address
      $mail->SMTPAuth   = true;
      $mail->Username   = 'your_smtp_harsha vardhan'; // Replace with your SMTP username
      $mail->Password   = 'your_smtp_Harshakai95'; // Replace with your SMTP password
      $mail->SMTPSecure = 'tls';
      $mail->Port       = 587;

      // Recipients
      $mail->setFrom('fromkanimerakalaharshavardhan@gmail.com', 'Your Name'); // Replace with your email address and name
...
?>
    ...
    <div class="job-postings">
        <h2 style="text-align:center">Saved Job Postings</h2>
