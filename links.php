...
<html lang="en">
    ...
    <body>
        ...
        <div class="row" >
                            <div class="res-box" style="text-align:center;width:100%,justify-content:center" >
...
<div class="res-box">
                                <div class="card text-white mb-4"style="text-align:center;background-color:#66d495">
                                    <div class="card-body"><P style="color:white">Admin Panel</P></div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link"style="text-align:center" href="admin">Login Here</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
